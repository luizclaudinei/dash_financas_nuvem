...
CATEGORIAS = ["Alimentação", "Transporte", "Lazer", "Moradia", "Salário", "Investimentos"]
...
st.download_button("Baixar CSV Filtrado", csv_operacoes, "financas_filtradas.csv", "text/csv")
